...
- Start Airflow. (This shall take a few good minutes, grab a coffee!)
  ...
  ```bash
  bash ~/Music-Streaming-Data-Pipeline/scripts/airflow_startup.sh && cd ~/Music-Streaming-Data-Pipeline/airflow
  ```
...
![music-streaming-data-pipeline-dag](../images/music-streaming-data-pipeline-dag.png)
